...
public class Car {
	 ...
	 public void setColor(String color){ //сеттер
		 if(color.equals("Black"))this.color = color;
		 if(color.equals("Red"))this.color = color;
		 if(color.equals("White"))this.color = color;
	 }
	 ...
	 public void setMarka(String marka){ //сеттер
		 if(marka.equals("BMW"))this.marka = marka;
	 }
	 ...
	 public void setNumber(String number){ //сеттер
		 if(number.equals("AAA 999"))this.number = number;
	 }
